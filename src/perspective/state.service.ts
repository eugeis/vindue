...
class Perspective {
	...
	getTree(): TreeInterface.Tree {
		return TreeInterface.copyTree(this.tree);
	}
}
...
export class StateService {
	...
	savePerspective(name: string, tree: TreeInterface.Tree) {
		this.persp = new Perspective(name, this.decycle(tree, undefined));
		console.log("Save");
		console.log(this.persp);
	}

	restorePerspective(name: string) {
		if (this.persp) {
			console.log("Restore");
			console.log(this.persp.getTree());
			return this.retrocycle(this.persp.getTree());
		}
	}
